/**
 * Lisanslar — Tüm bilgiler uygulama içinde. API hazır olduğunda liste burada gösterilecek.
 */
...
export default function LisanslarScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top + 16, paddingBottom: insets.bottom + 24 }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.title, { color: colors.textPrimary }]}>Lisanslar</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.message, { color: colors.textPrimary }]}>Lisans listesi uygulama içinde gösterilecek.</Text>
