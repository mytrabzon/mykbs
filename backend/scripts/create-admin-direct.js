// Admin Tesis Oluşturma Scripti (Direkt DATABASE_URL ile)
// Kullanım: DATABASE_URL="postgresql://..." node scripts/create-admin-direct.js
...
if (!process.env.DATABASE_URL) {
  ...
  console.error('💡 Kullanım: DATABASE_URL="postgresql://user:pass@host:port/db" node scripts/create-admin-direct.js');
  process.exit(1);
}
