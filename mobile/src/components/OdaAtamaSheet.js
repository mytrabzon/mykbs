...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 14, borderBottomWidth: 1, gap: 12, direction: 'ltr' },
  headerBackBtn: { padding: 4, marginRight: 4 },
  title: { flex: 1, fontSize: 18, fontWeight: '700', textAlign: 'left' },
